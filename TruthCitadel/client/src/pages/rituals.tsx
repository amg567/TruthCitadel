...
export default function Rituals() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/content/rituals"] });
      ...
      toast({
        title: "Success",
        description: "Ritual entry created successfully",
      });
    },
    onError: () => {
      toast({
        title: "Error",
        description: "Failed to create ritual entry",
        variant: "destructive",
      });
    },
  });
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: "Success",
        description: "Ritual entry updated successfully",
      });
    },
    onError: () => {
      toast({
        title: "Error",
        description: "Failed to update ritual entry",
        variant: "destructive",
      });
    },
  });
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: "Success",
        description: "Ritual entry deleted successfully",
      });
    },
    onError: () => {
      toast({
        title: "Error",
        description: "Failed to delete ritual entry",
        variant: "destructive",
      });
    },
  });
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-academia-brown/50 border-b border-academia-gold/20 p-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-3xl font-serif font-bold text-academia-gold">Rituals</h2>
              <p className="text-academia-beige/70 mt-1">Your sacred practices and meaningful routines</p>
            </div>
              ...
              <DialogContent className="bg-academia-dark border-academia-gold/20">
                <DialogHeader>
                  <DialogTitle className="text-academia-gold">
                    {editingEntry ? "Edit Ritual" : "Add Ritual"}
                  </DialogTitle>
                </DialogHeader>
                <Form {...form}>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input 
                              placeholder="Morning meditation, Evening reflection, etc." 
                              {...field}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea 
                              placeholder="Describe your ritual, its purpose, steps, and significance..."
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input 
                              placeholder="meditation, daily, morning, mindfulness"
                              {...field}
                              className="bg-academia-brown/30 border-academia-gold/20 text-academia-cream"
                            />
                          </FormControl>
        ...
        <main className="flex-1 p-6 overflow-y-auto">
          {isLoading ? (
            ...
            <div className="text-center py-16">
              <Sparkles className="w-16 h-16 text-academia-gold/50 mx-auto mb-4" />
              <h3 className="text-xl font-serif text-academia-gold mb-2">No rituals yet</h3>
              <p className="text-academia-beige/70 mb-6">Create your first ritual to start building meaningful practices.</p>
              <Button 
